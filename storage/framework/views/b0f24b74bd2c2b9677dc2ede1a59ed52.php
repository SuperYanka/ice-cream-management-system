...
<?php $__env->startSection('content'); ?>
    ...
    <table class="table" >
        ...
        <?php $__currentLoopData = $ice_creams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ice_cream): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
         ...
         <td class="table-rows-cols"><?php echo e($ice_cream -> rating); ?></td>
...
<?php echo $__env->make('app.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\KPI_Labs\laba-9\sweetydreams\resources\views/app/types/list.blade.php ENDPATH**/ ?>